...
/* Will
 * -certified csgo pro and pro hacker
 * 
 * Abilities
 * -has a matrix hack ability, pulls out laptop and can destroy all enemies on screen or hack locked doors
...
public class Will extends Sprite {
	...
	public Will(TileMap tm, GameStateManager gsm) {
		super(tm);
