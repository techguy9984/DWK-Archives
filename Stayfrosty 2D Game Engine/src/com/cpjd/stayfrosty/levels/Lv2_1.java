...
// APPROVED
public class Lv2_1 extends GameState {
	...
	public Lv2_1(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv2_1.txt");
		...
		m = new Minimap("/Minimaps/Lv2_1.png",1,1);
		
		player.setPosition(266, 1487);
	...
	private void populateEnemies() {
		...
		troll.setPosition(1515, 520);
		trollers.add(troll);
		
		Troller troll2;
		troll2 = new Troller(tileMap);
		troll2.setPosition(1520, 520);
		trollers.add(troll2);
		
		Troller troll3;
		troll3 = new Troller(tileMap);
		troll3.setPosition(1525, 520);
		trollers.add(troll3);
		
		Spoder spoder;
		spoder = new Spoder(tileMap);
		spoder.setPosition(1334, 1466);
		spoders.add(spoder);
	}
