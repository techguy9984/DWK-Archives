...
// APPROVED
public class Lv3_2 extends GameState {
	...
	public Lv3_2(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv3_2.txt");
		...
		m = new Minimap("/Minimaps/Lv3_2.png",1,1);
		
		tutorial = new Tutorial(Tutorial.Penguin,0,0,1000,1000,60 * 4, 5, GamePanel.HEIGHT - 50);
	...
	private void populateEnemies() {
		...
		Penguin p = new Penguin(tileMap, 545.0);
