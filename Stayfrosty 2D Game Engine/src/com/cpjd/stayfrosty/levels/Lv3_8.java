...
// APPROVED
public class Lv3_8 extends GameState {
	...
	public Lv3_8(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv3_8.txt");
		...
		m = new Minimap("/Minimaps/Lv3_8.png",1,1);
	}
	private void save() {
	...
	private void populateEnemies() {
		...
		spoder.setPosition(129, 258);
		spoders.add(spoder);
		
		Spoder spoder2;
		spoder2 = new Spoder(tileMap);
		spoder2.setPosition(296, 453);
		spoders.add(spoder2);
		
		Spoder spoder3;
		spoder3 = new Spoder(tileMap);
		spoder3.setPosition(720, 650);
		spoders.add(spoder3);
		
		Spoder spoder4;
		spoder4 = new Spoder(tileMap);
		spoder4.setPosition(808, 830);
		spoders.add(spoder4);
		
		Spoder spoder5;
		spoder5 = new Spoder(tileMap);
		spoder5.setPosition(1475, 1028);
		spoders.add(spoder5);
