...
// APPROVED
public class Lv3_3 extends GameState {
	...
	public Lv3_3(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv3_3.txt");
		...
		m = new Minimap("/Minimaps/Lv3_3.png",1,1);
	}
	private void save() {
	...
	private void populateEnemies() {
		...
		nut.setPosition(720, 350);
		nuts.add(nut);
		
		Bird nut2 = new Bird(tileMap, 720);
		nut2.setPosition(100, 350);
		nuts.add(nut2);
	}
