...
// APPROVED
public class Lv2_5 extends GameState {
	...
	public Lv2_5(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv2_5.txt");
		...
		m = new Minimap("/Minimaps/Lv2_5.png",1,1);
	...
	private void populateEnemies() {
		...
		il.setPosition(170, 1470);
		il.setRange(2000);
		illuminati.add(il);
		
		Illuminati il2;
		il2 = new Illuminati(tileMap);
		il2.setPosition(300, 850);
		il2.setRange(2000);
		illuminati.add(il2);
		
		Illuminati il3;
		il3 = new Illuminati(tileMap);
		il3.setPosition(600, 850);
		il3.setRange(2000);
		illuminati.add(il3);
	}
