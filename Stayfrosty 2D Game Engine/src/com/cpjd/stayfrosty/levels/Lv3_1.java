...
// APPROVED
public class Lv3_1 extends GameState {
	...
	public Lv3_1(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv3_1.txt");
		tileMap.setPosition(168,396);
		...
		tutorial = new Tutorial("Running simulator 2016!!",0,250,600,600,60 * 5,5,GamePanel.HEIGHT - 50);
	}
	private void save() {
	...
	private void populateEnemies() {
		...
		dogg.setPosition(15275,380);
		dogg.setStartX(15275);
		doggs.add(dogg);
		
		Gangster dogg2;
		dogg2 = new Gangster(tileMap);
		dogg2.setPosition(2000,380);
		dogg2.setStartX(2000);
		doggs.add(dogg2);
		
		Gangster dogg3;
		dogg3 = new Gangster(tileMap);
		dogg3.setPosition(10000,380);
		dogg3.setStartX(10000);
		doggs.add(dogg3);
	}
