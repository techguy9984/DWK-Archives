...
// APPROVED
public class Lv3_5 extends GameState {
	...
	public Lv3_5(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv3_5.txt");
		...
		m = new Minimap("/Minimaps/Lv3_5.png",1,1);
