...
// APPROVED
public class Lv3_9 extends GameState {
	...
	public Lv3_9(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv3_9.txt");
		...
		m = new Minimap("/Minimaps/Lv3_9.png",1,1);
