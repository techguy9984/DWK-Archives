...
// APPROVED
public class Lv2_8 extends GameState {
	...
	public Lv2_8(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv2_8.txt");
		...
		m = new Minimap("/Minimaps/Lv2_8.png",1,1);
	}
	private void save() {
