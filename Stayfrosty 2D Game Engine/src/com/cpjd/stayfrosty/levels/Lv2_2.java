...
// APPROVED
public class Lv2_2 extends GameState {
	...
	public Lv2_2(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv2_2.txt");
		...
		m = new Minimap("/Minimaps/Lv2_2.png",1,1);
		
		player.setPosition(1949, 1500);
	...
	private void populateEnemies() {
		...
		twelve.setPosition(622, 650);
		twelves.add(twelve);
		
		Twelve twelve2 = new Twelve(tileMap);
		twelve2.setPosition(2178, 700);
		twelves.add(twelve2);
	
		Twelve twelve3 = new Twelve(tileMap);
		twelve3.setPosition(2014, 113);
		twelves.add(twelve3);
	...
	public void draw(Graphics2D g) {
		...
		g.fillRect(0, 0, GamePanel.WIDTH / 3, GamePanel.HEIGHT);
		g.fillRect(GamePanel.WIDTH - (GamePanel.WIDTH / 3),0, GamePanel.WIDTH / 3, GamePanel.HEIGHT);
		g.fillRect(GamePanel.WIDTH / 3, 0, GamePanel.WIDTH, GamePanel.HEIGHT / 3);
		m.draw(g);
	}
