...
// APPROVED
public class Lv1_5 extends GameState {
	...
	public Lv1_5(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv1_5.txt"); // The map file, generated from Tiled
		...
		mb = new MovingBlock(tileMap, 1784, 415, 600); // The x position, y position, and range
		
		player.setPosition(800,970); // Player location on tilemap
		
		m = new Minimap("/Minimaps/Lv1_5.png",1,1);
	...
	private void populateEnemies() {
		...
		il.setPosition(1800, 1180);
		illuminati.add(il);
		
		Troller troll;
		troll = new Troller(tileMap);
		troll.setPosition(200, 240);
		trollers.add(troll);
	}
