...
// APPROVED
public class Lv2_7 extends GameState {
	...
	private MovingBlock m2;
	private MovingBlock m3;
	
	public Lv2_7(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv2_7.txt");
		...
		m = new Minimap("/Minimaps/Lv2_7.png",1,1);
		
		mb = new MovingBlock(tileMap, 371, 260, 1900);
		m2 = new MovingBlock(tileMap, 2336, 260, 2000);
		m3 = new MovingBlock(tileMap, 4771, 260, 6200 - 4771);
	}
	private void save() {
	...
	public void update() {
		...
		if(Player.globalX < 2271) mb.checkPlayerCollision(player);
		if(Player.globalX > 2272 && Player.globalX < 4475) m2.checkPlayerCollision(player);
		if(Player.globalX > 4476) m3.checkPlayerCollision(player);
	...
	public void keyPressed(int k) {
		...
		//m.keyPressed(k);
		if(k == KeyEvent.VK_G) AudioPlayer.playSound(SKeys.Error);
