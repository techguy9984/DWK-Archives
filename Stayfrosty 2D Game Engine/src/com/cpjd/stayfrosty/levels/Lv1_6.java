...
// APPROVED
public class Lv1_6 extends GameState {
	...
	public Lv1_6(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv1_6.txt");
		...
		m = new Minimap("/Minimaps/Lv1_6.png",1,1);
		
		player.setPosition(200, 1170);
