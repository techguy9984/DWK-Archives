...
// APPROVED
public class Lv1_3 extends GameState {
	...
	public Lv1_3(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv1_3.txt"); // The map file, generated from Tiled
		...
		mb = new MovingBlock(tileMap, 2481, 1434, 550); // The x position, y position, and range
		
		player.setPosition(94, 1809); // Player location on tilemap
		
		m = new Minimap("/Minimaps/Lv1_3.png",1 ,1);
		...
		t = new Tutorial(Tutorial.police,970,1353,400,400,60 * 4,5,GamePanel.HEIGHT - 50);
	}
