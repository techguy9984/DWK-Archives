...
// APPROVED
public class Lv2_4 extends GameState {
	...
	public Lv2_4(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv2_4.txt");
		...
		m = new Minimap("/Minimaps/Lv2_4.png",1,1);
	...
	private void populateEnemies() {
		...
		il.setPosition(1091, 1460);
		illuminati.add(il);
		
		Illuminati il2;
		il2 = new Illuminati(tileMap);
		il2.setPosition(1400, 1460);
		illuminati.add(il2);
		
		Illuminati il3;
		il3 = new Illuminati(tileMap);
		il3.setPosition(1714, 1460);
		illuminati.add(il3);
		
		Illuminati il4;
		il4 = new Illuminati(tileMap);
		il4.setPosition(2023, 1460);
		illuminati.add(il4);
		
		Illuminati il5;
		il5 = new Illuminati(tileMap);
		il5.setPosition(2351, 1460);
		illuminati.add(il5);
	}
