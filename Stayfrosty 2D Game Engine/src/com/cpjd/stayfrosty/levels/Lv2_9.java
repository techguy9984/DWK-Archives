...
// APPROVED
public class Lv2_9 extends GameState {
	...
	public Lv2_9(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv2_9.txt");
		...
		m = new Minimap("/Minimaps/Lv2_9.png",1,1);
