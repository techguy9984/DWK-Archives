...
// APPROVED
public class Lv2_6 extends GameState {
	...
	public Lv2_6(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv2_6.txt");
		...
		m = new Minimap("/Minimaps/Lv2_6.png",1,1);
	...
	private void populateEnemies() {
		...
		troll.setPosition(1115, 1083);
		trollers.add(troll);
		
		Bird nut = new Bird(tileMap, 1400);
		nut.setPosition(1000, 500);
		nuts.add(nut);
	}
