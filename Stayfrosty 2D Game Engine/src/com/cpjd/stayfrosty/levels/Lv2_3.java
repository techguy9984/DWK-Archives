...
// APPROVED
public class Lv2_3 extends GameState {
	...
	public Lv2_3(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
		...
		tutorial = new Tutorial(Tutorial.Skeleton,1530, 520, 1914 - 1530,765 - 520,60 * 8, 5, GamePanel.HEIGHT - 50);
	}
	
	public void init() {
		tileMap = new TileMap(64);
		tileMap.load64("/Tilesets/tileset.png");
		tileMap.loadTiledMap("/Maps/Lv2_3.txt");
		...
		m = new Minimap("/Minimaps/Lv2_3.png",1,1);
