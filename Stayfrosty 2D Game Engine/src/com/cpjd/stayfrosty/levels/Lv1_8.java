...
// APPROVED
public class Lv1_8 extends GameState {
	...
	public Lv1_8(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv1_8.txt");
		...
		m = new Minimap("/Minimaps/Lv1_8.png",1,1);
