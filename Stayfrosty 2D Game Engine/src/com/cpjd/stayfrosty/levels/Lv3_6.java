...
import com.cpjd.stayfrosty.entity.enemies.Gangster;
...
import com.cpjd.stayfrosty.entity.enemies.Spoder;
...
// APPROVED
public class Lv3_6 extends GameState {
	...
	public Lv3_6(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv3_6.txt");
		tileMap.setPosition(113,831);
		...
		m = new Minimap("/Minimaps/Lv3_6.png",1,1);
	...
	private void populateEnemies() {
		...
		il.setPosition(878, 810);
		illuminati.add(il);
		
		Troller troll;
		troll = new Troller(tileMap);
		troll.setPosition(1742, 522);
		trollers.add(troll);
		
		Gangster dogg;
		dogg = new Gangster(tileMap);
		dogg.setPosition(678, 810);
		dogg.setStartX(300);
		doggs.add(dogg);
		
		Spoder spoder;
		spoder = new Spoder(tileMap);
		spoder.setPosition(1078, 810);
		spoders.add(spoder);
		
		Twelve twelve = new Twelve(tileMap);
		twelve.setPosition(2175, 656);
		twelves.add(twelve);
		
		Bird nut = new Bird(tileMap, 720);
		nut.setPosition(720, 150);
		nuts.add(nut);
		
		Penguin p = new Penguin(tileMap, 417);
		p.setPosition(1024, 475);
		penguins.add(p);
	}
