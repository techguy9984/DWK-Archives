...
// APPROVED
public class Lv3_7 extends GameState {
	...
	public Lv3_7(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv3_7.txt");
		...
		m = new Minimap("/Minimaps/Lv3_7.png",1,1);
	...
	private void populateEnemies() {
		...
		Penguin p = new Penguin(tileMap, 91);
		p.setPosition(902, 91);
		penguins.add(p);
		
		Penguin p2 = new Penguin(tileMap, 91);
		p2.setPosition(1544, 91);
		penguins.add(p2);
		
		Penguin p3 = new Penguin(tileMap, 91);
		p3.setPosition(2539, 91);
		penguins.add(p3);
	}
