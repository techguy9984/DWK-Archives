...
// APPROVED
public class Lv1_9 extends GameState {
	...
	public Lv1_9(GameStateManager gsm, Load load, Save save) {
		super(gsm, load, save);
	...
	public void init() {
		...
		tileMap.loadTiledMap("/Maps/Lv1_9.txt");
		...
		mb = new MovingBlock(tileMap, 2150, 404, 2837 - 2150);
		
		player.setPosition(3050, 1445);
		...
		m = new Minimap("/Minimaps/Lv1_9.png",1,1);
	...
	private void populateEnemies() {
		...
		il.setPosition(160, 1450);
		illuminati.add(il);
		
		Point[] point = {
			new Point(1758, 1090), new Point(1648, 718),
			new Point(730, 700), new Point(1887, 315),
			new Point(1110, 126)
		};
		
		for(int i = 0; i < point.length; i++) {
			Troller t = new Troller(tileMap);
			t.setPosition(point[i].x, point[i].y);
